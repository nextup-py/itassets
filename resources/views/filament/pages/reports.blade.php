        ...
        <x-filament::card>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                <div class="p-4 bg-gray-50 rounded-lg text-center">
                    <div class="text-3xl font-bold text-gray-700">{{ $totalAssets }}</div>
                ...
                <div class="p-4 bg-blue-50 rounded-lg text-center">
                    <div class="text-3xl font-bold text-blue-600">{{ $assignedAssets }}</div>
                    <div class="text-sm text-gray-500 mt-1">Asignados</div>
                </div>
                <div class="p-4 bg-yellow-50 rounded-lg text-center">
                    <div class="text-3xl font-bold text-yellow-600">{{ $maintenanceAssets }}</div>
                    <div class="text-sm text-gray-500 mt-1">En mantenimiento</div>
                </div>
                <div class="p-4 bg-red-50 rounded-lg text-center">
                    <div class="text-3xl font-bold text-red-600">{{ $retiredAssets }}</div>
                    <div class="text-sm text-gray-500 mt-1">Dados de baja</div>
                </div>
                <div class="p-4 bg-purple-50 rounded-lg text-center">
                    <div class="text-3xl font-bold text-purple-600">{{ format_currency($totalValue) }}</div>
